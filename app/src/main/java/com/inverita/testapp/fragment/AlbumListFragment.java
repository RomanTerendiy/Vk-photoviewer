...
//		Call<AlbumsList> callAlbums = vkServiceInterface.getAlbums();
...
//				albumList.setResponse(albums);
//				RecycleViewAdapter adapter = new RecycleViewAdapter(getActivity(), albums);
